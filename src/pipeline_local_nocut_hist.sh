...
if [[ $HIST_FLAG -eq 1 ]]; then
    fslmerge -t ./OUTPUTS/b0_all.nii.gz ./OUTPUTS/b0_d_smooth.nii.gz ./OUTPUTS/b0_u.nii.gz
    fslroi ./OUTPUTS/b0_all.nii.gz ./OUTPUTS/D.nii.gz 0 1
    fslroi ./OUTPUTS/b0_all.nii.gz ./OUTPUTS/U.nii.gz 1 1
    mrhistmatch linear ./OUTPUTS/U.nii.gz ./OUTPUTS/D.nii.gz ./OUTPUTS/U_histmatched.nii.gz
    mv ./OUTPUTS/b0_all.nii.gz ./OUTPUTS/b0_all_before_histmatch.nii.gz
    fslmerge -t ./OUTPUTS/b0_all.nii.gz ./OUTPUTS/D.nii.gz ./OUTPUTS/U_histmatched.nii.gz
fi
